...
if __name__=='__main__':
    ...
    from cost_functions import OCPRunningLockEERot, OCPRunningCostMinJointVel, OCPRunningOrthTool
    ...
    # create OCP
    problem = SingleShootingProblem('ssp', ode, x0, dt, N, conf.integration_scheme, simu)
    ...
    # Solve OCP
    problem.solve(y0=y0,use_finite_difference=conf.use_finite_difference, max_iter_grad = 150, max_iter_fd = 50)
